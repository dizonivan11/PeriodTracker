package com.streamside.periodtracker.ui.tracker
            ...
            periodViewModel.lastPeriod.observe(viewLifecycleOwner) { lastPeriod ->
                ...
                if (lastPeriod != null) {
                    ...
                    if (lastPeriod.periodEndYear == 0 &&
                        ...
                        val lastPeriodLength =
                            dayDistance(lastPeriodEndDate.time, currentPeriodDate.time)
                    ...
                    val lastCycleLength =
                        dayDistance(currentPeriodDate.time, lastPeriodDate.time)
    ...
    private fun initSmallCalendar(root: View, dates: List<Date>) {
        val smallCalendarViewManager = object : CalendarViewManager {
            override fun setCalendarViewResourceId(
                ...
                return if (isSelected) when (MainActivity.isSameDay(cal, periodDate)) {
                    true -> R.layout.period_selected_calendar_item
                    false -> R.layout.selected_calendar_item
                } else when (MainActivity.isSameDay(cal, periodDate)) {
        ...
        periodViewModel.currentPeriod.observe(viewLifecycleOwner) { period ->
            ...
            if (simulated) {
                ...
                if (MainActivity.isSameYearAndMonth(periodDate, currentCalendar)) {
                ...
                if (MainActivity.isSameYearAndMonth(
